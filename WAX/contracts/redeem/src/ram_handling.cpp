...
*/
ACTION nfthivecraft::withdrawram(
...
* and inline actions
*/
ACTION nfthivecraft::buyramproxy(
...
*/
void nfthivecraft::increase_collection_ram_balance(
    name collection_name,
    int64_t bytes
) {
...
*/
void nfthivecraft::decrease_collection_ram_balance(
    name collection_name,
    int64_t bytes,
...
* Throws if the collection does not have enough balance
*/
void nfthivecraft::test_collection_ram_balance(
    name collection_name,
    int64_t bytes,
    string error_message
) {
